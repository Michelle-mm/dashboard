...
export const ThemeSetting = () => {
    ...
    return (
        <div className="bg-half-trasparent w-screen fixed nav-item top-0 right-0 z-30">
            <div className="float-right h-screen dark:text-gray-200 bg-slate-100 z-40 dark:bg-[#484B52] w-400">
                ...
                <div className="flex-col border-t-1 border-color p-4 ml-4">
                    <p className="font-semibold text-xl" style={{color: currentColor}}>Theme Options</p>
                    <div className="mt-4">
                ...
                <div className="flex-col border-t-1 border-color p-4 ml-4">
                    ...
                    <div className="flex gap-3">
                        {themeColors.map((item, index)=>(
                            <TooltipComponent key={index} content={item.color}
                                            position="TopCenter">
